...
import { Loader2, Home, Building, DoorOpen, ShieldAlert } from 'lucide-react';
...
function MeetingsShell({ children }: { children: React.ReactNode }) {
    ...
    const hasAccess = React.useMemo(() => {
        ...
        return employeeProfile.role === 'admin' || !!employeeProfile.meetingsAccess;
    }, [employeeProfile]);
                ...
                <div className="text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Хурлын өрөө модулд нэвтрэх эрх олгогдоогүй байна.
                        </p>
                    </div>
            ...
            <header className="flex-none sticky top-0 z-40 w-full border-b bg-background">
                <div className="flex h-14 items-center justify-between gap-4 px-page">
                    ...
                    <div className="flex items-center gap-1">
                        <PortalSwitcher currentPortalId="meetings" />
                        <UserNav />
                    </div>
                </div>
            </header>
