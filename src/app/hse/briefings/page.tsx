...
export default function BriefingsPage() {
    ...
    return (
        <div className="p-page space-y-6">
            <PageHeader
                title="Зааварчилгаа"
                description="Ажлын байрны зааварчилгааны бүртгэл"
                hideBreadcrumbs
                actions={
            ...
            <DataTable>
                ...
                {isLoading ? (
                    ...
                    <DataTableEmpty columns={6} message="Зааварчилгааны бүртгэл алга" />
                ) : (
                    <DataTableBody>
                        {filtered.map((b) => {
                            const p = progress(b);
                            return (
                                <DataTableRow key={b.id}>
                                    ...
                                    <DataTableCell align="center">
                                        <StatusBadge tone={scheduleStatusTone(b.tuluw)}>{b.tuluw}</StatusBadge>
                                    </DataTableCell>
