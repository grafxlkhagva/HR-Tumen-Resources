...
interface TasksListTableProps {
    ...
    /** Таскийг чатад дурдах (mention) */
    onMentionInChat?: (task: Task) => void;
    /** Таск устгах */
...
export function TasksListTable({
    ...
    return (
                                ...
                                <div className="min-w-0">
                                    <div className="flex items-center gap-2 flex-wrap">
                                        <button
                                            type="button"
                                            className={cn(
                                                'text-sm font-semibold text-slate-900 dark:text-slate-100 hover:text-primary text-left',
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            {onMentionInChat && (
                                                <DropdownMenuItem onClick={() => onMentionInChat(task)}>
        ...
        <AlertDialog open={!!taskToDelete} onOpenChange={(open) => !open && setTaskToDelete(null)}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Таск устгах</AlertDialogTitle>
                    <AlertDialogDescription>
                        Та &quot;{taskToDelete?.title}&quot; таскыг устгахдаа итгэлтэй байна уу?
