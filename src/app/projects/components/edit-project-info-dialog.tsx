...
import { StrategyLinkSelector } from '@/components/strategy-link-selector';
...
export function EditProjectInfoDialog({ open, onOpenChange, project }: EditProjectInfoDialogProps) {
    ...
    const [strategyLink, setStrategyLink] = React.useState<NonNullable<Project['strategyLink']> | null>(
        project.strategyLink ?? null
    );
    ...
    React.useEffect(() => {
        if (project && open) {
            ...
            setStrategyLink(project.strategyLink ?? null);
        }
    }, [project, open, form]);
    ...
    const onSubmit = async (values: FormValues) => {
        ...
        try {
            ...
            // Стратегийн холбоос хадгалах (null бол устгана)
            updateData.strategyLink = strategyLink ?? null;
