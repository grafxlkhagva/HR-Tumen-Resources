                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                {/* Стратегийн холбоос badge */}
                                {project.strategyLink?.planId && (
                                    <div className="flex items-center gap-1 mt-0.5">
                                        <span className="inline-flex items-center gap-1 text-[10px] bg-violet-50 dark:bg-violet-950/40 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-800 rounded-full px-2 py-0.5 font-medium">
                                            <Target className="h-2.5 w-2.5" />
                                            {project.strategyLink.objectiveTitle
                                                ? project.strategyLink.objectiveTitle
                                                : project.strategyLink.planTitle}
                                        </span>
                                    </div>
                                )}
