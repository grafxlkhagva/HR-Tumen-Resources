...
export function CreateProjectDialog({ open, onOpenChange, groups = [], currentProjectCount = 0 }: CreateProjectDialogProps) {
    ...
    const [strategyLink, setStrategyLink] = React.useState<NonNullable<Project['strategyLink']> | null>(null);
    ...
    const onSubmit = async (values: ProjectFormValues) => {
        ...
        try {
            ...
            // Стратегийн холбоос
            if (strategyLink?.planId) {
                projectData.strategyLink = strategyLink;
            }
