            ...
            if (mode === 'edit' && templateId && firestore) {
                try {
                    ...
                    if (!snap.exists()) {
                        ...
                        router.push('/dashboard/official-letters/templates');
                        return;
                    }
        ...
        <div className="flex flex-col h-full bg-slate-50/50">
            <div className="p-6 md:p-8 space-y-6 overflow-y-auto pb-20">
                <PageHeader
                    ...
                    fallbackBackHref="/dashboard/official-letters/templates"
                    actions={
                                    ...
                                    <CardContent className="p-4 space-y-3">
                                        ...
                                        {companyProfile && (
                                            <p className="text-[11px] text-muted-foreground pt-1">
                                                Профайлыг <a href="/dashboard/company/edit" className="underline hover:text-primary" target="_blank" rel="noopener">Settings</a>-ээс засна
                                            </p>
                                        )}
                                    </CardContent>
                                </Card>
