...
export default function TemplatesPage() {
    ...
    const goCreate = () => router.push('/dashboard/official-letters/templates/new');
    const goEdit = (id: string) => router.push(`/dashboard/official-letters/templates/${id}/edit`);
    const goClone = (id: string) => router.push(`/dashboard/official-letters/templates/new?cloneFrom=${id}`);
