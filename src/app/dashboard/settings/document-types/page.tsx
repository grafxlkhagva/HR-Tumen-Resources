        ...
        <div className="py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="mb-8 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-semibold tracking-tight">Бичиг баримтын төрөл</h1>
                        <p className="text-muted-foreground">Албан бичиг, тушаал, гэрээний төрлүүдийг удирдах.</p>
                    </div>
                </div>
            </div>
            <div className="space-y-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Хөдөлмөрийн гэрээ, дотоод журам, тушаал гэх мэт төрлүүдийг тодорхойлох.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ReferenceTable
