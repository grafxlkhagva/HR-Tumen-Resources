...
export function AddPositionDialog({
  ...
  React.useEffect(() => {
    if (editingPosition) {
      form.reset({
        ...
        requirements: editingPosition.requirements?.join('\n') || '',
  ...
  const onSubmit = (data: PositionFormValues) => {
    ...
    if (isEditMode && editingPosition) {
      ...
      toast({ title: 'Амжилттай нэмэгдлээ. Бүтэц баталсны дараа хүчинтэй болно.' });
    }
                  ...
                  <div className="border-b px-6 flex justify-between items-center">
                    {mode === 'full' && (
                      <TabsList className="w-full justify-start h-12 bg-transparent p-0 gap-6">
                        ...
                        <TabsTrigger value="description" className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-0 h-12">Тодорхойлолт</TabsTrigger>
                    ...
                    {mode === 'full' && (
                      <>
                        <TabsContent value="description" className="mt-0 space-y-6">
                          <Card>
                            <CardHeader>
                              <CardTitle className="text-lg">Ажлын байрны тодорхойлолт</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                              <FormField
                                control={form.control}
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Үндсэн зорилго, чиг үүрэг</FormLabel>
                                    <FormControl>
                                      <Textarea
                                        placeholder="Энэ албан тушаал юу хийх, ямар зорилготой болохыг энд бичнэ үү..."
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Тавигдах шаардлага (Мөр бүрт нэг)</FormLabel>
                                    <FormControl>
                                      <Textarea
                                    ...
                                    <FormDescription>Шаардлагуудыг шинэ мөрөөр (Enter дарж) зааглан оруулна уу.</FormDescription>
                                    <FormMessage />
                                  </FormItem>
                                )}
                              />
