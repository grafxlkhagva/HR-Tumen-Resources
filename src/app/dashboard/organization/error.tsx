...
/**
 * organization модулийн алдааны хязгаар (Next.js route-level Error Boundary).
 *
 * Байгууллагын бүтэц модулийн доорх хуудсуудад (page.tsx, [departmentId]/page.tsx,
 * positions, settings гэх мэт) renderingийн үед throw болсон алдааг энэ компонент
            ...
            <div className="mx-auto max-w-md space-y-6">
                ...
                <div className="space-y-2">
                    <h2 className="text-xl font-semibold text-slate-900">
                        Байгууллагын бүтцийн модульд алдаа гарлаа
                    </h2>
