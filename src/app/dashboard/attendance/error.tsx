...
/**
 * attendance модулийн алдааны хязгаар (Next.js route-level Error Boundary).
 *
 * Цаг бүртгэлийн модулийн доорх хуудсуудад renderingийн үед throw болсон
 * алдааг энэ компонент барьж аваад user-д ойлгомжтой fallback UI харуулна.
 * Sentry-руу мөн capture хийнэ.
 */
            ...
            <div className="mx-auto max-w-md space-y-6">
                ...
                <div className="space-y-2">
                    <h2 className="text-xl font-semibold text-slate-900">
                        Цаг бүртгэлийн модульд алдаа гарлаа
                    </h2>
