// src/app/dashboard/hr/business-plan/components/create-kpi-dialog.tsx
'use client';
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <span className="flex items-start gap-1.5 text-xs mt-1 text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-md px-2.5 py-2">
                            <AlertTriangle className="h-3.5 w-3.5 mt-0.5 shrink-0" />
                            <span>
                                <strong>KPI</strong> нь өдөр тутмын операциональ хэмжүүр (ирц, борлуулалт г.м.).
                                Стратегийн ambition хэмжүүр бол <strong>OKR Key Result</strong> ашиглана уу.
                                KPI-г Objective-тэй холбох нь зайлсхийх хэрэгтэй — KPI нь OKR-ийн subset биш.
                            </span>
                        </span>
                    </DialogDescription>
                </DialogHeader>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="flex items-center gap-1.5">
                                            Холбоотой зорилго
                                            <span className="text-[10px] font-normal text-muted-foreground">(заавал биш)</span>
                                        </FormLabel>
                                        <Select onValueChange={field.onChange} value={field.value}>
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue placeholder="Сонголтот — зайлсхийхийг зөвлөнө" />
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
                                                {objectives.map(o => (
                                        ...
                                        {field.value && (
                                            <FormDescription className="text-amber-600 text-[11px]">
                                                ⚠️ KPI-г Objective-тэй холбох нь менежментийн шилдэг туршлагаас зөрнө. KPI нь тусдаа операциональ хэмжүүр байх ёстой.
                                            </FormDescription>
                                        )}
                                        <FormMessage />
                                    </FormItem>
