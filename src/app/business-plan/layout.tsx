...
import { useUser, useMemoFirebase, useDoc, useFirebase, useAuth } from '@/firebase';
...
function BusinessPlanShell({ children }: { children: React.ReactNode }) {
    ...
    const hasAccess = React.useMemo(() => {
        ...
        return employeeProfile.role === 'admin' || !!employeeProfile.businessPlanAccess;
    }, [employeeProfile]);
                ...
                <div className="text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Бизнес төлөвлөгөө модулд нэвтрэх эрх олгогдоогүй байна.
                        </p>
                    </div>
            ...
            <header className="flex-none sticky top-0 z-40 w-full border-b bg-background">
                <div className="flex h-14 items-center justify-between gap-4 px-page">
                    ...
                    <div className="flex items-center gap-1">
                        <PortalSwitcher currentPortalId="business_plan" />
                        <UserNav />
                    </div>
                </div>
            </header>
