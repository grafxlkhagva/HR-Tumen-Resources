 ...
 */
export default function RecurringTransportsError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    ...
    console.error('[tms/recurring-transports] list render error:', error);
  }, [error]);
    ...
    <div className="flex h-full w-full flex-col items-center justify-center gap-4 p-8 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-semibold">
          Давтамжит тээврийн мэдээлэл ачаалахад алдаа гарлаа.
        </h2>
