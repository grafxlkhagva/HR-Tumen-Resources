...
interface EditContractServiceDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    contractId: string;
    service: TmsContractService;
    allServices: TmsContractService[];
}

export function EditContractServiceDialog({
    open,
    onOpenChange,
    contractId,
    service,
    allServices,
}: EditContractServiceDialogProps) {
    ...
    const onSubmit = async (values: FormValues) => {
        ...
        try {
            ...
            toast({
                variant: 'destructive',
                title: 'Алдаа',
                description: e instanceof Error ? e.message : 'Үйлчилгээ засахад алдаа гарлаа.',
            });
        }
    };
    ...
    return (
        <AppDialog open={open} onOpenChange={onOpenChange}>
            <AppDialogContent size="lg" showClose>
                <AppDialogHeader>
                    <AppDialogTitle>Үйлчилгээ засах</AppDialogTitle>
                    <AppDialogDescription>
                        Тээврийн үйлчилгээний мэдээллийг засна уу.
                    </AppDialogDescription>
                </AppDialogHeader>
                <Form {...form}>
